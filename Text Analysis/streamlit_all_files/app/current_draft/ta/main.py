...
tot_samp1_df = top_10_df[(top_10_df['product'] == 'BBQ - Control (Texas BBQ)')  & (top_10_df['question'] == selectbox_option)]
tot_samp2_df = top_10_df[(top_10_df['product'] == 'BBQ - Test 13')  & (top_10_df['question'] == selectbox_option)]
tot_samp3_df = top_10_df[(top_10_df['product'] == 'BBQ - Test 14')  & (top_10_df['question'] == selectbox_option)]
...
tot_fig = go.Figure(data=[
    ...
    go.Bar(name= tot_samp3_df['product'].unique()[0], x=tot_samp3_df['word'], y=tot_samp3_df['frequency'], text=tot_samp3_df['frequency']),
])
# Change the bar mode
...
sen_tot_fig = go.Figure(data=[
    ...
    go.Bar(name= tot_samp3_df['product'].unique()[0], x=tot_samp3_df['word'], y=tot_samp3_df['sentiment_mean'], text=round(tot_samp3_df['sentiment_mean'])),
])
# Change the bar mode
