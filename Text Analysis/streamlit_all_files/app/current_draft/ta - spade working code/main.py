...
global_options = ['Liking', 'Change', 'All Questions']

#Setup side bar
with st.sidebar:
    selectbox_option = st.sidebar.selectbox(
    "Choose Question",
    ('Liking', 'Change', 'All Questions'))
...
tot_samp1_df = top_10_df[(top_10_df['product'] == 'High Drizzle')  & (top_10_df['question'] == selectbox_option)]
tot_samp2_df = top_10_df[(top_10_df['product'] == 'Low Drizzle')  & (top_10_df['question'] == selectbox_option)]
